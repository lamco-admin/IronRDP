...
//! is 300ms per MS-RDPEUDP2 Section 3.1.1.2.3, not TCP's 1 second.
//!
...
///
/// MS-RDPEUDP2 Section 3.1.1.2.3 specifies that the retransmission
/// timeout must be at least 300ms. This is lower than TCP's 1s minimum
/// (RFC 6298 Section 2.4) because the protocol operates over a
/// typically low-latency network path (RDP sessions).
