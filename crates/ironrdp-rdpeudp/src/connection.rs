...
mod tests {
    use super::*;
    use crate::error::RdpeudpErrorKind;
    ...
    fn full_handshake_client_server() {
        ...
        let mut syn_ack_bytes = syn_ack_transmit.contents.clone();
        client
        ...
        let mut ack_bytes = ack_transmit.contents.clone();
        server
    ...
    fn establish_pair() -> (RdpeudpConnection, RdpeudpConnection, MonotonicInstant) {
        ...
        let mut ack_bytes = final_ack.contents.clone();
        server
            .handle_datagram(&mut ack_bytes, later(t, 100))
            .expect("handle ACK");
    ...
    fn data_delivery_roundtrip() {
        ...
        let mut data_bytes = data_pkt.contents.clone();
        server
    ...
    fn bidirectional_data() {
        ...
        let mut pkt_bytes = pkt.contents.clone();
        server
    ...
    fn keep_alive_fires() {
        ...
        // Should set ack_pending, which poll_transmit picks up
